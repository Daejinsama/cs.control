...
namespace com.outlook_styner07.cs.control.Data
{
    ...
    public class DataGridViewNumericUpDownColumn : DataGridViewColumn
    {
            ...
            set
            {
                ...
                if (DataGridView != null)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        DataGridViewNumericUpDownCell dataGridViewCell = (DataGridViewNumericUpDownCell)dataGridViewRow.Cells[Index];
        ...
        {
            return !Increment.Equals(DataGridViewNumericUpDownCell.DEFAULT_INCREMENT);
        }

        /// Indicates whether the Maximum property should be persisted.
        private bool ShouldSerializeMaximum()
        {
            return !Maximum.Equals(DataGridViewNumericUpDownCell.DEFAULT_MAXIMUM);
        }

        /// Indicates whether the Maximum property should be persisted.
        private bool ShouldSerializeMinimum()
        {
            return !Minimum.Equals(DataGridViewNumericUpDownCell.DEFAULT_MINIMUM);
        }
        ...
        public override string ToString()
        {
            return new StringBuilder()
                .Append("DataGridViewNumericUpDownColumn { Name=")
                .Append(Name)
                .Append(", Index=")
                .Append(Index.ToString(CultureInfo.CurrentCulture))
                .Append(" }").ToString();
        }
        #endregion
    }
